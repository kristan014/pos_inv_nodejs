...
exports.findOne = async (req, res) => {
 ...
 exports.update = async (req, res) => {
    ...
    if (stock != undefined) {
        addToStock(req.body.stock, req.body.updated_by, res);
...
const deleteOldPoItems = async (oldPoItems, id, res) => {
    await oldPoItems.forEach(function(item) {
        PoItem.destroy({
            where: { 
                purchase_order: id,
                product: item 
...
const addToStock = async (stock, user, res) => {
    await stock.forEach(function(item) {
